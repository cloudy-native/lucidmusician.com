...
**Plugins reviewed:**
[Scaler 3](#scaler-3-plugin-boutique) · [Captain Chords](#captain-chords-mixed-in-key) · [ChordJam](#chordjam-audiomodern) · [Cthulhu](#cthulhu-xfer-records) · [Spacewalk](#spacewalk-higher-plane) · [Chordz](#chordz-codefn42) · [Ripchord](#ripchord-trackbout) · [Tonespace](#tonespace-mucoder) · [AudioCipher](#audiocipher-midi-vault) · [MIDI Wizard 2.0](#midi-wizard-20-unison-audio) · [LANDR Composer](#landr-composer) · [InstaComposer 2](#instacomposer-2-wa-production) · [Liquid Music](#liquid-music-wavedna) · [Fluid Chords](#fluid-chords-pitch-innovations) · [ChordConverter](#chordconverter-feelyoursound) · [World Chord Generator](#world-chord-generator-mario-nieto) · [Pentacom ChordBloom](#pentacom-chordbloom) · [dBdone AI Chords](#dbdone-ai-chords) · [Harvest Mini](#harvest-mini)

**Analysis:**
[Quick picks](#quick-picks) · [So where does that leave LucidHarmony?](#so-where-does-that-leave-lucidharmony)
